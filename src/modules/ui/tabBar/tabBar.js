...
import { calculateOverflow } from 'ui/overflowLibrary';
import { LightningResizeObserver } from 'ui/resizeObserver';
import { handleKeyDownOnTabList } from './keyboard';

const i18n = {
  more: 'More',
  moreAlternativeText: 'More',
  moreTitle: 'More',
  errorStateAlternativeText: 'Error'
};
